...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Zombie', callback_data='zombie'),
            ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ʏᴛ-ᴛʜᴜᴍʙ', callback_data='ytthumb'),
            InlineKeyboardButton('ᴡᴀʀɴ', callback_data='warn'),
            InlineKeyboardButton('Zombies', callback_data='zombie'),
            ],[
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='start'),
            InlineKeyboardButton('sᴛᴀᴛᴜs', callback_data='stats'),
            InlineKeyboardButton('ᴄʟᴏsᴇ x', callback_data='close_data')
...
async def advantage_spell_chok(msg):
    ...
    if not movielist:
        k = await msg.reply(f"`Hey, {msg.from_user.mention}! I couldn't find anything related to {msg.text} Did you mean any one of these below 👇 ?`")
