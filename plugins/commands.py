...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        ...
        await client.send_sticker(chat_id=message.chat.id, sticker='CAACAgUAAxkBAAJc-GIfWR3hIR_5MRjwkOdkT41wrBcHAAIVAQACyJRkFGZEMKKnFWwTHgQ', reply_to_message_id=message.message_id)
